...
// Digital Board - Lazy loaded for performance
const DigitalBoard = lazy(() => import("../components/digitalBoard/DigitalBoard"));
// Lesson Plans - Lazy loaded for performance
const LessonPlans = lazy(() => import("../components/lessonPlans/LessonPlans"));
      ...
      <Nav>
        ...
        {isLoggedin ? (
          <Route path="/auth" element={<AuthViews />}>
            ...
            <Route path="/auth/digital-board" element={<DigitalBoard />} />
            <Route path="/auth/lesson-plans" element={<LessonPlans />} />
