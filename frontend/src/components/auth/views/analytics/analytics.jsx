            ...
            <Grid container spacing={3} sx={{ mb: 3 }}>
                <Grid item xs={12} sm={6} md={3}>
                    <StatCard
                        ...
                        value={logStats?.todays_activity || 0}
                ...
                <Grid item xs={12} sm={6} md={3}>
                    <StatCard
                        ...
                        value={logStats?.total_downloads || 0}
                        icon={<DownloadIcon sx={{ fontSize: 40 }} />}
                        color="#ff9800"
                    />
                </Grid>
                <Grid item xs={12} sm={6} md={3}>
                    <StatCard
                        ...
                        value={logStats?.recent_activity_count || 0}
                        icon={<PeopleIcon sx={{ fontSize: 40 }} />}
                        color="#4caf50"
                    />
                </Grid>
                        ...
                        {userLogs.length === 0 ? (
                            ...
                            userLogs.map((log, idx) => (
                                <TableRow key={idx}>
                                    ...
                                    <TableCell>
                                        <Typography variant="body2">{log.user || log.user_name || 'Unknown'}</Typography>
                                        <Typography variant="caption" color="text.secondary">{log.email || log.user_email}</Typography>
                                    </TableCell>
                                    <TableCell>
