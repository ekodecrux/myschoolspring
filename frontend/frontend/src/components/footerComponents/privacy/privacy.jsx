...
var Privacy = () => {
  ...
  return (
    <div style={{ margin: isMobile ? "35px 10px" : "20px 80px" }}>
              ...
              <strong>
                <span style={{ fontSize: '15px' }}>
                  <span data-custom-class="subtitle">
                    Last updated
                    <span className="question">November 20, 2022</span>
                  </span>
                </span>
              </strong>
            </span>
          ...
          <div style={{ lineHeight: '1.5' }}>
            <span style={{ color: 'rgb(127, 127, 127)' }}>
              <span style={{ color: 'rgb(89, 89, 89)', fontSize: '15px' }}>
                <span data-custom-class="body_text">
                  ...
                  <span className="question">Edwiser Innovation hub private limited</span>
                        ...
                        <span style={{ color: 'rgb(89, 89, 89)' }}>
                          <span data-custom-class="body_text">
                            <span style={{ fontSize: '15px' }}>
                              <span style={{ color: 'rgb(89, 89, 89)' }}>
                                <span className="statement-end-if-in-editor">
                                  <span className="block-component"> or any other application of ours that links to this privacy notice</span>
                                </span>
                              </span>
                            </span>
                          </span>
              ...
              <span style={{ fontSize: '15px' }}>
                <span style={{ color: 'rgb(127, 127, 127)' }}>
                  <span data-custom-class="body_text">
                    ...
                    <span className="question">info@myschool.in</span>
                    .
                  </span>
                </span>
              </span>
            ...
            <div style={{ lineHeight: '1.5' }}>
              <span style={{ fontSize: '15px' }}>
                <span data-custom-class="body_text">
                  ...
                  <span className="block-component" />
                  here:
                  <span className="question"><a href="http://www.myschool.in" target="_blank" data-custom-class="link">http://www.myschool.in</a></span>
                  <span className="else-block" />
            ...
            <ul>
              <li style={{ lineHeight: '1.5' }}>
                <span style={{ fontSize: '15px' }}>
                  <span data-custom-class="body_text">
                    <span className="question">student data</span>
                  </span>
                </span>
              </li>
            </ul>
              ...
              <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                  <span data-custom-class="body_text">
                    ...
                    <span className="question">razorpay</span>
                    <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                      <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                        <span data-custom-class="body_text">
                          <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                          ...
                          <span className="question"><a href="https://razorpay.com/privacy/" target="_blank" data-custom-class="link">https://razorpay.com/privacy/</a></span>
                          <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                            <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                              <span data-custom-class="body_text">
                                <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
            ...
            <div style={{ lineHeight: '1.5' }}>
              ...
              <div style={{ lineHeight: '1.5' }}>
                <span className="block-component"><span style={{ fontSize: '15px' }}><span data-custom-class="body_text" /></span></span>
                <div style={{ lineHeight: '1.5' }}>
                  <span className="block-component"><span style={{ fontSize: '15px' }}><span data-custom-class="body_text" /></span></span>
                  <div style={{ lineHeight: '1.5' }}>
                    <span className="block-component"><span style={{ fontSize: '15px' }}><span data-custom-class="body_text" /></span></span>
                  ...
                  <div style={{ lineHeight: '1.5' }}><br /></div>
                  <div style={{ lineHeight: '1.5' }}>
                    <span className="statement-end-if-in-editor"><span style={{ fontSize: '15px' }}><span data-custom-class="body_text" /></span></span>
                  </div>
                    ...
                    <div style={{ lineHeight: '1.5' }}>
                      ...
                      <div style={{ lineHeight: '1.5' }}>
                        ...
                        <div style={{ lineHeight: '1.5' }}>
                          ...
                          <div style={{ lineHeight: '1.5' }}>
                            <span className="block-component"><span style={{ fontSize: '15px' }} /></span>
                            <div style={{ lineHeight: '1.5' }}>
                              <span className="block-component"><span style={{ fontSize: '15px' }} /></span>
                              <div style={{ lineHeight: '1.5' }}>
                                <span className="block-component"><span style={{ fontSize: '15px' }} /></span>
                                  ...
                                  <div style={{ lineHeight: '1.5' }}>
                                    ...
                                    <div style={{ lineHeight: '1.5' }}>
                                      ...
                                      <div style={{ lineHeight: '1.5' }}>
                                        ...
                                        <div style={{ lineHeight: '1.5' }}>
                                          <span style={{ fontSize: '15px' }}>
                                            <span className="block-component"><span data-custom-class="body_text" /></span>
                                          </span>
                                          <div style={{ lineHeight: '1.5' }}>
                                            <span className="block-component"><span style={{ fontSize: '15px' }}><span data-custom-class="body_text" /></span></span>
                                            <div style={{ lineHeight: '1.5' }}>
                                                                        ...
                                                                        <div style={{ lineHeight: '1.5' }}>
                                                                            ...
                                                                            <span style={{ color: 'rgb(89, 89, 89)', fontSize: '15px' }}>
                                                                              <span style={{ fontSize: '15px' }}>
                                                                                <span style={{ color: 'rgb(89, 89, 89)' }}>
                                                                                  <span style={{ fontSize: '15px' }}>
                                                                                    <span style={{ color: 'rgb(89, 89, 89)' }}>
                                                                                      <span className="block-component"><span data-custom-class="heading_1" /></span>
                                                                                    </span>
                                                                                  </span>
                                                                                </span>
                                                                              </span>
                                                                          ...
                                                                          <ul>
                                                                            <li style={{ lineHeight: '1.5' }}>
                                                                              <span data-custom-class="body_text">
                                                                                <span style={{ fontSize: '15px' }}>
                                                                                  <span className="question">Log in to your account settings and update your user account.</span>
                                                                                </span>
                                                                              </span>
                                                                            </li>
                                                                          </ul>
                                                                          ...
                                                                          <ul>
                                                                            <li style={{ lineHeight: '1.5' }}>
                                                                              <span data-custom-class="body_text">
                                                                                <span style={{ fontSize: '15px' }}>
                                                                                  <span className="question">Contact us using the contact information provided.</span>
                                                                                </span>
                                                                              </span>
                                                                            </li>
                                                                          </ul>
                                                                          ...
                                                                          <div style={{ lineHeight: '1.5' }}>
                                                                            <span style={{ fontSize: '15px' }}>
                                                                              <span data-custom-class="body_text">
                                                                                <span className="question">Musheerabad</span>
                                                                                <span style={{ color: 'rgb(89, 89, 89)' }}>
                                                                                  <span style={{ fontSize: '15px' }}>
                                                                                    <span className="block-component" />
                                                                                  </span>
                                                                          ...
                                                                          <div style={{ lineHeight: '1.5' }}>
                                                                            <span style={{ fontSize: '15px' }}>
                                                                              <span data-custom-class="body_text">
                                                                                <span className="question">Secunderabad</span>
                                                                                <span style={{ color: 'rgb(89, 89, 89)' }}>
                                                                                  <span style={{ fontSize: '15px' }}>
                                                                                    <span className="block-component" />
                                                                                    ,
                                                                                    <span className="question">Telangana</span>
                                                                                    <span className="statement-end-if-in-editor" />
                                                                                    <span className="block-component" />
                                                                                    <span className="question">500020</span>
                                                                                    <span className="statement-end-if-in-editor" />
                                                                                    <span className="block-component" />
                                                                                    <span className="block-component" />
                                                                                  </span>
                                                                          ...
                                                                          <div style={{ lineHeight: '1.5' }}>
                                                                            <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                                                                              <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                                                                                ...
                                                                                <span data-custom-class="body_text">
                                                                                  &nbsp;visit:
                                                                                  <span className="question"><a href="http://www.myschool.in" target="_blank" data-custom-class="link">https://www.myschool.in</a></span>
                                                                                  <span className="else-block" />
                                                                                </span>
                                                                              </span>
